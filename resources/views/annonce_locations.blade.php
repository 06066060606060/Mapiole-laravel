                     ...
                     <div class="grid items-start grid-cols-1 gap-8 md:grid-cols-2">
                         ...
                         <div class="sticky top-0">
                             <div class="flex">
                                 ...
                                 <button
                                     class="rounded-full  bg-green-800 px-3 py-0.5 text-xs font-medium tracking-wide text-white">
                                     Location
                                 </button>
                             </div>
                             <div class="flex justify-between mt-8">
                                 <div class="max-w-[35ch]">
                                     ...
                                     <h1 class="text-2xl font-bold">
                                      ...
                                      <a class="py-2 mb-4 text-sm font-bold text-gray-600">Région:<span class="text-black"> {{ $locations->ville }}</span> </a>
                                 </div>
                     ...
                     <map class="relative text-gray-600">
                         <div class="absolute inset-0 bg-gray-300">
                             <iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0"
                                 ...
                                 src="https://maps.google.com/maps?width=100%&height=600&hl=en&q='.{{ $locations->ville }} .'&ie=UTF8&t=&z=14&iwloc=B&output=embed"
