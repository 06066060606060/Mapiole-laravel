...
function backgroundSequence() {
	...
	for (i = 0; i < bgImageArray.length; i++) {
		setTimeout(function(){ 
			document.getElementById('dvImage').style.background = "url(" + base + bgImageArray[k] + ") no-repeat center center fixed";
			document.getElementById('dvImage').style.backgroundSize ="cover";
