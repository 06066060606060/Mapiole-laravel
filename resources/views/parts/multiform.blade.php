			...
			<div x-show.transition="step === 'complete'">
				<div class="bg-white rounded-lg p-10 flex items-center shadow justify-between">
					<div>
						...
						<h2 class="text-2xl mb-4 text-gray-800 text-center font-bold"> Success</h2>
			...
			<div x-show.transition="step != 'complete'">	
				...
				<div class="border-b-2 py-4">
					...
					<div class="flex flex-col md:flex-row md:items-center md:justify-between">
						<div class="flex-1">
							<div x-show="step === 1">
								<div class="text-lg font-bold text-gray-700 leading-tight">Type de bien</div>
							</div>
							
							<div x-show="step === 2">
								<div class="text-lg font-bold text-gray-700 leading-tight">Details du bien</div>
							</div>

							<div x-show="step === 3">
								<div class="text-lg font-bold text-gray-700 leading-tight">Enregister annonce</div>
							</div>
						</div>
				...
				<div class="py-10">	
					<div x-show.transition.in="step === 1">
						...
						<div class="mb-5">
							<label for="email" class="font-bold mb-1 text-gray-700 block">Type de bien</label>
							...
							<div class="flex">
								<label
									...
									<div class="select-none text-gray-700">Maison</div>
								</label>
								...
								<label
									...
									<div class="select-none text-gray-700">Appartement</div>
								</label>
                                <label
									class="flex justify-start items-center text-truncate rounded-lg bg-white pl-4 pr-6 py-3 shadow-sm">
									<div class="text-teal-600 mr-3">
									...
									<div class="select-none text-gray-700">Terrain</div>
								</label>
							</div>
						</div>
