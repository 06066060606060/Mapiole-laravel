            ...
            <div class="flex flex-col pb-4 space-y-2 align-baseline md:pb-0">
                ...
                <details class="group" open>
                    ...
                    <div class="flex flex-col">
                        <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="/">&nbsp; -A
                            louer</a>
                        <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp; -A
                            vendre</a>
                        <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp; -Un
                            professionel</a>
                        <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp; -Un
                            locataire</a>
                    </div>
            ...
            <details class="group">
                ...
                <div class="flex flex-col">
                    <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp; -Recherche
                        immobilière</a>
                    <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp; -Estimation
                        immobilière</a>
                    <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="construire">&nbsp; -Conseil et
                        acommpagnement</a>
                    <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp;-document
                        administratif</a>
