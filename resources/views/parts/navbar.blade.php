<section id="navbar" class="fixed top-0 z-10 flex w-full pt-2 pb-2 transition duration-200 border-b border-gray-400 border-x-1 justify-evenly">
    <nav x-data="{ isOpen: false }" class="w-full py-2 mx-4 md:mx-8">
      <div class="flex items-center justify-between">
        ...
        <div class="flex">
          <div class="hidden pt-2 mx-4 lg:flex">
            <a class="mx-2 font-bold text-gray-100 hover:text-gray-800 hover:border-b-4 hover:border-gray-900 darked" href="louer"
              @click="isOpen = false">&nbsp;
              Louer</a>
                      <a class="mx-2 font-bold text-gray-100 hover:text-gray-800 hover:border-b-4 hover:border-gray-900 darked" href="acheter"
              @click="isOpen = false">&nbsp;
              Acheter</a>
          ...
          <button @click="isOpen = !isOpen" type="button"
            class="text-gray-400 hover:text-gray-400 focus:outline-none focus:text-gray-400 " aria-label="toggle menu">
      ...
      <div class="flex justify-center pt-4 lg:hidden">
        <a class="mx-1 text-sm font-bold text-gray-800 border-b-4 border-gray-900 darked" href="/"
          @click="isOpen = false">&nbsp;
          Louer</a>
        <a class="mx-1 text-sm font-bold text-gray-400 hover:text-gray-800 darked" href="recherche"
          @click="isOpen = false">&nbsp; Acheter</a>
        <a class="mx-1 text-sm font-bold text-gray-400 hover:text-gray-800 darked" href="vendre"
          @click="isOpen = false">&nbsp; Vendre</a>
        <a class="mx-1 text-sm font-bold text-gray-400 hover:text-gray-800 darked" href="construire"
          @click="isOpen = false">&nbsp; Construire</a>
        <a class="mx-1 text-sm font-bold text-gray-400 hover:text-gray-800 darked" href="services"
      ...
      <div x-cloak :class="[!isOpen ? 'translate-x-full opacity-0 ' : 'opacity-100 translate-x-0']"
        ...
        <div class="flex flex-col pb-4 space-y-2 align-baseline md:pb-0">
          ...
          <details class="group" open>
            ...
            <div class="flex flex-col">
              ...
              <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp; -Objets à
                vendre</a>
              <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="construire">&nbsp; -Projets de
                construction</a>
            </div>
          </details>
          ...
          <details class="group" open>
            ...
            <div class="flex flex-col">
              <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="/">&nbsp; -Estimation
                immobilière</a>
              <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp; -Créer une
                annonce</a>
              <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="construire">&nbsp; -Projets de
                construction</a>
            </div>
          ...
          <details class="group">
            ...
            <div class="flex flex-col">
              <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp; -Recherche
                immobilière</a>
              <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="construire">&nbsp; -Conseil et
                acommpagnement</a>
              <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="recherche">&nbsp; -Commander
                un
                document administratif</a>
              <a class="px-2 py-1 text-sm text-gray-600 hover:bg-gray-100" href="construire">&nbsp; - Commander
                une main d'oeuvre</a>
